...
class DiziMom : MainAPI() {
    ...
    private suspend fun Element.sonBolumler(): SearchResponse? {
        ...
        val posterUrl = getPosterUrl(this.selectFirst("a img"))
    ...
    private fun Element.diziler(): SearchResponse? {
        ...
        val posterUrl = getPosterUrl(this.selectFirst("div.cat-img img"))
    ...
    private fun getPosterUrl(element: Element?): String? {
        ...
        val src = element.attr("data-src").takeIf { it.isNotBlank() } ?: element.attr("src")
        return fixUrlNull(src.replace(Regex("""-\d+x\d+(?=\.)"""), ""))
    }
}
